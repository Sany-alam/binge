...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-10 col-sm-10 col-10 offset-md-1 offset-sm-1 main_page_new_order">
           ...
           <form action="{{route('bp-remakrs-submit')}}" method="post">
           @csrf
               <div class="row">
                   <div class="col-md-3 p-0 m-0">
                   
                    <label for="Customer Instruction" class="">Admin Remarks:</label>
                   </div>
                   <div class="col-md-9 p-0 m-0">
                   <input type="hidden" class="form-control" name="id" id="fullname" placeholder="Full Name" value="{{$id}}">
                  
                


                  
                    <textarea class="form-control" name="admin_remarks" id="exampleFormControlTextarea1" rows="3" ></textarea>
